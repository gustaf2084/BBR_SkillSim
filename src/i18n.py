...
_add("forward.result_title_ph","请在左侧选择背景与特性，点击「计算概率分布」",
      "Select a background and traits on the left, then click \"Calculate Distribution\"")
...
_add("forward.calc_err_prefix",  "计算过程出错：\n",    "An error occurred during calculation:\n")
...
_add("reverse.result_title_ph","选择目标技能树组，点击「推导最佳组合」",
      "Select target groups, then click \"Derive Best Combos\"")
...
_add("reverse.empty_body",   "该目标组无任何背景+特性组合可生成。\n尝试选择更通用的组作为目标，或打开高级选项允许多特性组合。",
      "No background+trait combination can generate these target groups.\nTry a more general target, or enable multi-trait combos in Advanced.")
...
_add("reverse.err_prefix",   "推导过程出错：\n",        "An error occurred during derivation:\n")
